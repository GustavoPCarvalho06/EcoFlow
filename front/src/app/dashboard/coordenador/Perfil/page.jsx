// src/app/dashboard/coordenador/Perfil/page.jsx (VERSÃO CORRIGIDA)

// [CORREÇÃO] A importação foi corrigida para usar o componente correto.
...
export default async function Perfil() {
  ...
  return (
    ...
    >
      {/* [CORREÇÃO] Agora estamos chamando o componente correto */}
      {/* [CORREÇÃO] A prop 'usuario' foi ajustada para o formato que a NavUser espera */}
      <AppSidebarCoordenador variant="inset" usuario={ user } />
